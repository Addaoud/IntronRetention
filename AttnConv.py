...
from src.networks import build_AttenConv
from src.seed import set_seed
from src.config import AttentionConvConfig
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train and evaluate the AttentionConv model"
    )
    ...
    config = AttentionConvConfig(**read_json(json_path=args.json))
