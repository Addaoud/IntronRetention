...
from src.networks import Basset
from src.seed import set_seed
from src.config import BassetConfig
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train and evaluate the Basset-like model"
    )
    ...
    config = BassetConfig(**read_json(json_path=args.json))
    ...
    model = Basset(config.model_architecture).to(device)
    if args.new:
